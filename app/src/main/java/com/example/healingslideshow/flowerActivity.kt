...
class flowerActivity : AppCompatActivity() {
    ...
    class MyAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm) {
        ...
        private val resources = listOf(
            ...
            R.drawable.flowerfield,
            R.drawable.forgetmenot,
            R.drawable.heartshape,
            R.drawable.japanesecherrytrees,
            R.drawable.springflowers,
            R.drawable.summer,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        player = MediaPlayer.create(this, R.raw.flowersong)
